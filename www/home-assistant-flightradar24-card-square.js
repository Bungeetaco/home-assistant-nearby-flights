 ...
 * Modified for this repo: custom element renamed (flightradar24-card →
 * nearby-flights-map-card) and a square-radar CSS patch (border-radius
 * 50% → 12px).
 */
                ...
                <div class="section-content">
                    ...
                    <div class="item-box">
                        <div class="form-row">
                            ...
                            <input type="text" class="full-width" id="tap-action" placeholder="https://globe.adsbexchange.com/?lat=\${map_lat}&lon=\${map_lon}&zoom=\${zoom}" value="${this._config.tap_action||""}" />
                        </div>
